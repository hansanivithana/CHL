...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <a class="navbar-brand" href="#">All For Music Instructor</a>
            ...
            <div class="col-md-8">
                ...
                <div class="list-group">
                   <a href="Add_learningPackages.php" class="list-group-item list-group-item-action">Add Learning Packages</a>
                    ...
                    <a href="AddLatestMusic.php" class="list-group-item list-group-item-action">Add Notations</a>

                    <a href="viewRequestd.php" class="list-group-item list-group-item-action">ViewRequest</a>
